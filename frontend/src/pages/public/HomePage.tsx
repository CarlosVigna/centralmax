...
export function HomePage() {
  return (
    <>
        ...
        <div className="mx-auto max-w-6xl px-4">
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-3">
            <BenefitCard
              icon="📦"
              title="Variedade"
              description="Amplo catálogo de embalagens para todo tipo de negócio"
            />
            <BenefitCard
              icon="✅"
              title="Qualidade"
              description="Produtos selecionados de fornecedores homologados"
            />
            <BenefitCard
              icon="🚚"
              title="Agilidade"
              description="Atendimento rápido e entrega eficiente em São José do Rio Preto e região"
            />
          </div>
        </div>
      </section>
      ...
      {/* Catálogo */}
      <section id="catalogo" className="bg-neutral-100 py-16">
        <div className="mx-auto max-w-6xl px-4">
          <h2 className="mb-2 text-center text-2xl font-bold text-primary">Nosso Catálogo</h2>
          <p className="mb-8 text-center text-sm text-neutral-600">
            Clique em qualquer produto para adicionar ao orçamento
          </p>
          <CatalogSection />
        </div>
      </section>
